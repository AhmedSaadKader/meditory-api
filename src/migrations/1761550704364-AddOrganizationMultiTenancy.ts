...
export class AddOrganizationMultiTenancy1761550704364 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "operational"."role_pharmacies" DROP CONSTRAINT IF EXISTS "fk_role_pharmacies_pharmacy"`);
        await queryRunner.query(`ALTER TABLE "operational"."role_pharmacies" DROP CONSTRAINT IF EXISTS "fk_role_pharmacies_role"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_dosage_forms_category"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_dosage_forms_raw_name"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_dosage_forms_standard_name"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_dosage_forms_standardized"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_dosage_forms_synonyms"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_routes_admin_type"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_routes_raw_name"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_routes_standard_name"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_routes_standardized"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "reference"."idx_routes_synonyms"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "operational"."idx_stock_fefo_lookup"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "operational"."idx_stock_expiry_monitoring"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "operational"."idx_stock_low_level"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "operational"."idx_movement_pharmacy_date"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "operational"."idx_movement_drug_audit"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "operational"."idx_role_pharmacies_role"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "operational"."idx_role_pharmacies_pharmacy"`);
        await queryRunner.query(`ALTER TABLE "operational"."pharmacy_stock" DROP CONSTRAINT IF EXISTS "check_quantity_non_negative"`);
        await queryRunner.query(`ALTER TABLE "operational"."pharmacy_stock" DROP CONSTRAINT IF EXISTS "check_allocated_non_negative"`);
        await queryRunner.query(`ALTER TABLE "operational"."pharmacy_stock" DROP CONSTRAINT IF EXISTS "check_allocated_within_quantity"`);
        await queryRunner.query(`ALTER TABLE "operational"."pharmacy_stock" DROP CONSTRAINT IF EXISTS "check_cost_price_positive"`);
        await queryRunner.query(`ALTER TABLE "operational"."pharmacy_stock" DROP CONSTRAINT IF EXISTS "check_selling_price_positive"`);
        ...
        await queryRunner.query(`ALTER TABLE "reference"."dosage_forms" DROP CONSTRAINT IF EXISTS "dosage_forms_raw_name_key"`);
        ...
        await queryRunner.query(`ALTER TABLE "reference"."routes" DROP CONSTRAINT IF EXISTS "routes_raw_name_key"`);
